...
from bluto.modules.get_dns import (
    action_brute_start,
    action_wild_cards,
    action_zone_transfer,
    get_dns_details,
    action_brute_wild,
    set_resolver)

from bluto.modules.search import (
    action_bing_true,
    action_google,
    action_linkedin,
    action_netcraft,
...
from bluto.modules.get_file import (
    get_subs,
    get_sub_interest,
    get_line_count,
    get_user_agents)

from bluto.modules.general import (
    action_country_id,
    action_whois,
    action_bluto_use, check_dom)

from bluto.modules.output import (
    action_output_vuln_zone,
    action_output_wild_false,
    action_output_wild_false_hunter,
        ...
        {8} | {7} | {10}
               {11}  |  {12}
                 ...
                 {0}  |  {1}
                     {5}
""".format(
    colored("Author: Darryl Lane", 'blue'),
...
def main():
    ...
    try:
        ...
        if args['--timeout']:
            ...
            myResolver.timeout = float(10)
            myResolver.lifetime = float(10)
